...
client.on("message", message => {
  if (message.content === "aops tos") {
    return message.channel.send("Discord TOS: https://discord.com/terms\nAoPS TOS: https://artofproblemsolving.com/company/tos");
  }
});
client.on("message", message => {
  if (message.content === "aops rules") {
    return message.channel.send("Check <#796544244839088129> for the rules of this server!");
  }
});
client.on("message", message => {
...
client.on("ready", () =>{
    ...
    client.user.setPresence({
        ...
        game: {
            name: "Say \"aops help\" to see my commands!",  //The message shown
